...
$GvmArgCompleteScriptBlock = {
    ...
    Invoke-Expression $GvmPythonCommand -OutVariable completionResult -ErrorVariable errorOut -ErrorAction SilentlyContinue | Out-Null
...
Register-ArgumentCompleter -Native -CommandName $GvmCommandAlias -ScriptBlock $GvmArgCompleteScriptBlock