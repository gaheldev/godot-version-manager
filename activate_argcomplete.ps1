$GdvmPythonCommand = "./dist/gdvm/gdvm.exe"
$GdvmCommandAlias = "gdvm"

Function gdvm {
    Invoke-Expression "$GdvmPythonCommand $args"
}

$GdvmArgCompleteScriptBlock = {
    ...
    Invoke-Expression $GdvmPythonCommand -OutVariable completionResult -ErrorVariable errorOut -ErrorAction SilentlyContinue | Out-Null
...
Register-ArgumentCompleter -Native -CommandName $GdvmCommandAlias -ScriptBlock $GdvmArgCompleteScriptBlock
